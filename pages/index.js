...
import { testLightMachine, makeUseOfLightMachine } from '../machines/trafficLightMachine'
  ...
  return (
    <Container>
      <div css={tw`font-bold text-lg bg-gray-100 m-64 p-4 rounded`}>
        ...
        <button css={tw `border-2 rounded p-2 m-2 shadow text-green-600 border-green-600`} onClick={() => (makeUseOfLightMachine('NEXT'))}>call NEXT transition on red</button>
